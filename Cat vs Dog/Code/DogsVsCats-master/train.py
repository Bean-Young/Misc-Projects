...
dataset_dir = 'E:/Python/Project/Cat vs Dog/'                                                  # 数据集路径

model_cp = 'E:/Python/Project/Cat vs Dog/DogsVsCats/DogsVsCats-master/model(VGG16)/'               # 网络参数保存位置
...
def train():
    ...
    criterion = torch.nn.CrossEntropyLoss().cuda()                         # 定义loss计算方法，cross entropy，交叉熵，可以理解为两者数值越接近其值越小
