...
parser.add_argument('--model_path', type=str, default= '/media/Storage4/yyz_code/MDPI-US/res_yyz/times/model_RTrans_20.pth',    #'/home/yyz/result/writer/model_RTrans_68.pth' #'/media/Storage4/yyz_code/MDPI-US/res_yyz/vgg/model_RTrans_30.pth'
                    help='the path of pretrained model')#'/home/yyz/RViT-main/model/final.pth'
parser.add_argument('--model_save_dir', type=str, default='/media/Storage4/yyz_code/MDPI-US/res_yyz/ours_c/',
                    help='the path of the trained model')
parser.add_argument('--writer_save_dir', type=str, default='/media/Storage4/yyz_code/MDPI-US/res_yyz/ours_c/',
