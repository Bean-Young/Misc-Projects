...
if __name__ == '__main__':
    ...
    # 设定不同惩罚方式的逻辑回归模型
    models = {
        "Logistic Regression (L1 penalty)": LogisticRegression(solver='saga', penalty='l1', max_iter=10000),
        "Logistic Regression (L2 penalty)": LogisticRegression(solver='saga', penalty='l2', max_iter=10000)
    }
