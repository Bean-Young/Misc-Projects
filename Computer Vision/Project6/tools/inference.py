...
def get_opts() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model-config-path",
        type=str,
        default="./model_configs/VOC-Detection/yolov3.cfg",
        help="path to model config file. Default: ``./model_configs/VOC-Detection/yolov3.cfg``",
    )
    parser.add_argument(
        "--img-size",
        type=int,
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="./results/pretrained_models/YOLOv3_Tiny-VOC-20231107.pth.tar",
        help="path to weights file. Default: ``./results/pretrained_models/YOLOv3_Tiny-VOC-20231107.pth.tar``",
    )
    parser.add_argument(
        "--half",
        action="store_true",
