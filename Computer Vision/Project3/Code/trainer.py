...
class Trainer:
    ...
    def __init__(self, model, device, train_loader, test_loader, classes):
        ...
        self.scheduler = optim.lr_scheduler.ReduceLROnPlateau(
            self.optimizer, 'min', patience=3, factor=0.5, verbose=True
        )
    ...
    def save_model(self, path='./Result/cifar10_model.pth'):
        # 确保目录存在
    ...
    def load_model(self, path='./Result/cifar10_model.pth'):
