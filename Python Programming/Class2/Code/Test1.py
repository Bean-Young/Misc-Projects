...
def test2():
    setA = literal_eval(input("Please enter a set\n"))
    setB = literal_eval(input("Please enter a set\n"))
...
def test4():
    lis=literal_eval(input("Please enter a list containing several integers\n"))
    lis=list(filter(lambda x: x % 2 == 0,lis))
    print("List only with even number:",lis)
def test5():
    lisA=literal_eval(input("Please enter a listA\n"))
    lisB=literal_eval(input("Please enter a listB\n"))
...
def test8():
    pointA = literal_eval(input("Enter coordinate pointA\n"))
    pointB = literal_eval(input("Enter coordinate pointB\n"))
    distance = map(lambda x, y: abs(x - y), pointA, pointB)
    print("Manhattan distance between two points:", sum(distance))
def test9():
    sets=literal_eval(input("Please enter a list containing several sets\n"))
