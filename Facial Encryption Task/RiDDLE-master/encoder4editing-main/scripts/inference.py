...
if __name__ == "__main__":
    ...
    parser.add_argument("--images_dir", type=str, default='E:/RiDDLE-master/RiDDLE_weights_and_data/data',
                        help="The directory of the images to be inverted")
    parser.add_argument("--save_dir", type=str, default='E:/RiDDLE-master/RiDDLE_weights_and_data/data',
    ...
    parser.add_argument("--ckpt", metavar="CHECKPOINT", default=r"E:\RiDDLE-master\encoder4editing-main\e4e_ffhq_encode.pt",help="path to generator checkpoint")
