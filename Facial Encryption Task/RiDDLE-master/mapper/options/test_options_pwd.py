...
class TestOptions:
	...
	def initialize(self):
		self.parser.add_argument('--e4e_model_weights', default= r"E:\RiDDLE-master\RiDDLE_weights_and_data\pretrained_models\e4e_ffhq_encode_256.pt", type=str, help="The latents for the training")
		self.parser.add_argument('--stylegan_weights', default= r"E:\RiDDLE-master\RiDDLE_weights_and_data\pretrained_models\stylegan2-ffhq-256.pt", type=str, help="The latents for the training")
		self.parser.add_argument('--stylegan_size', default= 256, type=int, help="stylegan image size")
		self.parser.add_argument('--ir_se50_weights', default=r'E:\RiDDLE-master\RiDDLE_weights_and_data\pretrained_models\model_ir_se50.pth', type=str, help="Path to facial recognition network used in ID loss")
		self.parser.add_argument('--id_cos_margin', default=0.1, type=float, help='margin for id cosine similarity')
		self.parser.add_argument('--mapper_weight', default=r"E:\RiDDLE-master\RiDDLE_weights_and_data\pretrained_models\iteration_90000.pt",type=str, help="The latents for the validation")
		...
		self.parser.add_argument('--latent_path', default=r"E:\RiDDLE-master\RiDDLE_weights_and_data\embeddings\invert_w_256.pt", type=str, help="The id embedding for the training")
		self.parser.add_argument('--image_path', default=r"E:\RiDDLE-master\RiDDLE_weights_and_data\data", type=str, help="The id embedding for the training")
